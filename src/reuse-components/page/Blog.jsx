  ...
  return (
    <div className="min-h-[90vh] bg-gray-950 flex flex-col items-center justify-center px-4 text-center">
      ...
      <p className="text-gray-600 text-lg max-w-md mb-6">
        We're building something amazing. Our blog will be available soon!
      </p>
      ...
      <div className="flex flex-col sm:flex-row items-center gap-3 w-full max-w-md">
        <input
          ...
          className="w-full px-4 py-2 border border-gray-300 placeholder:text-white text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
        />
