      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex space-x-8">
            ...
            <a href="#" className="text-gray-600 hover:text-indigo-600 font-medium">Docs</a>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button className="bg-indigo-600 text-white px-4 py-2 rounded-md hover:bg-indigo-700 transition">Sign Up</button>
          </div>
        </div>
      </div>
    </nav>
